...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  extractZipFlat:   (p, dest, exts)   => ipcRenderer.invoke('fs:extractZipFlat', p, dest, exts),
  ...
  extractRarFlat:   (p, dest, exts)   => ipcRenderer.invoke('fs:extractRarFlat', p, dest, exts),
